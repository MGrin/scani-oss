          ...
          >
            <motion.div variants={fadeInUp} className="mb-8">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                Scani is currently in alpha development. We're building the most
                comprehensive portfolio tracking platform for investors managing
                international wealth across multiple currencies and asset
                classes.
              </p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We're building powerful tools for international wealth management.
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We're actively building powerful tools for international wealth
              management.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              We're methodically building advanced financial tools for
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 pr-20">
                  {feature.title}
                </h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                  {feature.description}
          ...
          >
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-2xl border border-gray-200">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Be among the first to experience the future of international
                wealth management. Alpha access provides early feature access
                and direct developer feedback.
              </p>
          ...
          >
            {[
              ...
              },
              {
                ...
                title: "Track & Analyze",
                description:
                  "Get hourly portfolio insights and detailed analytics.",
              },
              {
                step: "04",
                title: "Stay Informed",
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Scani is designed for serious investors managing international
              portfolios. Join our alpha program to experience intelligent
              wealth management that understands global finance.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto">
              <p className="text-white text-lg font-medium mb-4">
                🎯 <strong>Alpha Program:</strong> Exclusive access for serious
                investors
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Scani. All rights reserved.
            </p>
