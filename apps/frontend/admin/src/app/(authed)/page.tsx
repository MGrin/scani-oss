      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          {fly.ok ? (
            <>
              ...
              <div className="text-neutral-400">{fly.data.apps.map((a) => a.name).join(' · ')}</div>
            </>
          ) : (
        ...
        >
          ...
          {cfBilling.ok ? (
            ...
            <div className="text-neutral-500 text-xs">billing: {cfBilling.error}</div>
          )}
        </ServiceCard>
          ...
          {fastmail.ok ? (
            fastmail.data.tokenConfigured ? (
              <>
                ...
                <div className="text-neutral-400">No public billing API</div>
              </>
            ) : (
              <div className="text-neutral-400">Token not configured</div>
            )
          ) : (
