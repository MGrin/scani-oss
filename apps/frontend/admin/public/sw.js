/**
 * Scani Admin PWA Service Worker
...
const STATIC_CACHE = `scani-admin-static-${CACHE_VERSION}`;
const DYNAMIC_CACHE = `scani-admin-dynamic-${CACHE_VERSION}`;
const API_CACHE = `scani-admin-api-${CACHE_VERSION}`;

const STATIC_ASSETS = ['/', '/manifest.json', '/favicon.ico'];
// Admin proxies all backend calls through Next.js route handlers under
// /api/* — there's no direct /trpc endpoint here.
 ...
 * Next.js emits hashed chunks under `/_next/static/` — everything under
 * that prefix is content-addressed and safe to pin forever.
 */
