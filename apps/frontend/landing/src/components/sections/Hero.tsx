...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center px-6 pt-20 pb-24 text-center sm:pt-28 sm:pb-32">
        <a
          href="#beta"
        ...
        <p className="mt-6 max-w-2xl text-balance text-base text-muted-foreground sm:text-lg">
          ...
          real-time portfolio view — runnable as a managed SaaS, a metered cloud API, or a
        ...
        <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
          ...
          <a
            href="https://api.cloud.scani.xyz/docs"
            target="_blank"
