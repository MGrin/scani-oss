/**
 * Scani Cloud PWA Service Worker
...
const STATIC_CACHE = `scani-cloud-static-${CACHE_VERSION}`;
const DYNAMIC_CACHE = `scani-cloud-dynamic-${CACHE_VERSION}`;
const API_CACHE = `scani-cloud-api-${CACHE_VERSION}`;
