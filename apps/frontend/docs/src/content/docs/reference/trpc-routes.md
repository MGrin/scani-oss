...
| `mobile` | Lean, typed read **and write** endpoints for the mobile apps (accounts, holdings, groups, vaults) — idempotent create/update/delete mutations wrapping the domain services; exposed via the OpenAPI mobile contract. |
