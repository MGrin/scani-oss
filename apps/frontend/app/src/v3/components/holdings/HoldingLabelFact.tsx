 ...
 * a holding that already exists, which is why production held 100 rows with a
 * NULL label: the four RUB rows the feature was designed for were created
 * before the column existed and could never acquire a name (SC-564).
 *
