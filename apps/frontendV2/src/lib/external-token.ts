...
export function isExternalTokenValue(value: string | undefined | null): value is string {
...
export function parseExternalTokenValue(value: string): ExternalTokenPayload | null {
  ...
  try {
    ...
    return parsed && typeof parsed.symbol === 'string' && typeof parsed.name === 'string'
      ? parsed
      : null;
  } catch {
    return null;
