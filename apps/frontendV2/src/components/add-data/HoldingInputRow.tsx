...
export function HoldingInputRow({
  ...
  const hasAmountError =
    hasError &&
    (!amount.trim() || Number.isNaN(Number.parseFloat(amount)) || Number.parseFloat(amount) <= 0);
    ...
    <div className={containerClassName}>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end gap-4">
        <div className="w-full md:flex-1">
          ...
          <div className={hasTokenError ? 'ring-2 ring-red-500 rounded-md' : ''}>
        ...
        {originalAmount ? (
          <div className="w-full md:w-auto flex flex-col md:flex-row items-start md:items-end gap-2 md:gap-2">
            ...
            <div className="w-full md:w-32">
              <Label className={`text-sm ${hasAmountError ? 'text-red-600' : ''}`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4 flex-wrap">
          <Button
            ...
            className={showTrashIcon ? 'text-red-600 hover:text-red-700 hover:bg-red-50' : ''}
          >
