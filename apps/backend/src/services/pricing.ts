...
import type { PricingProviderKey, ProviderPriceResult, TokenWithProvider } from './pricing/types';
...
export class PricingService {
  ...
  private readonly finnhubRateLimiter = new RateLimiter(50, 60 * 1000);
  private readonly coinGeckoRateLimiter = new RateLimiter(40, 60 * 1000);
  ...
  private async fetchFromAllProviders(
    ...
    const primaryProviders: PrimaryProviderKey[] = ['exchangeRate', 'coinGecko', 'finnhub'];
