...
export class PortfolioValuationService {
   ...
   * @param userBaseCurrencyId - Optional base currency ID (if not provided, will be fetched)
...
// ================================================================
// Note: Use TypeDI Container.get(PortfolioValuationService) to get instance
// ================================================================
