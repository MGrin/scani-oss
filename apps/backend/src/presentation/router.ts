...
const tokenPricesRouter = createTokenPricesRouter(Container.get(TokenPriceRepository));
...
const holdingsRouter = createHoldingsRouter(
  Container.get(HoldingRepository),
  Container.get(HoldingService)
);
...
const batchOperationsRouter = createBatchOperationsRouter(Container.get(BatchOperationsService));
