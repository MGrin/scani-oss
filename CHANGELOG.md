...
* **providers:** say at boot which providers came up without a key (SC-536) ([2021f35](https://github.com/MGrin/scani-oss/commit/2021f35188fbf82fcccd128b2ed8c4a1bcbf09ec))
...
* **review:** ask what an unexplained balance change was (SC-501) ([f04ea7b](https://github.com/MGrin/scani-oss/commit/f04ea7b2da93c49e98fc0052ab8a76fdae843ce8))
...
* **deps:** deps:unused can see an unused file ([ec7e4f2](https://github.com/MGrin/scani-oss/commit/ec7e4f2f78100ff09f94337d16a37c99185ab9a4))
...
* **docker:** reconcile docker-readmes against the published image set ([3dfe977](https://github.com/MGrin/scani-oss/commit/3dfe977947e0666ee53775d4cd907a31a8058d66))
...
* **docs:** compile every .mdx page in docs:check ([3788db5](https://github.com/MGrin/scani-oss/commit/3788db5036e77c633faa62d608cf8c06140a02dc))
...
* **e2e:** a spec path handed to test:e2e is a path, not a project (SC-533) ([1695ba2](https://github.com/MGrin/scani-oss/commit/1695ba26e033796a8c6f1a2eadd2df74b9777b63))
...
* **jobs:** the owner sees only what somebody wrote for them (SC-551) ([64aaae1](https://github.com/MGrin/scani-oss/commit/64aaae168163c107654370cbf61b0aa889b2648d))
...
* **migrate-image:** apply the queue schema, not just Drizzle (SC-535) ([343400f](https://github.com/MGrin/scani-oss/commit/343400fc435ac12cde3d4a136796242804624bc4))
...
* **release:** bound the commit walk, or 0.15.0 comes out as 0.4.0 (SC-540) ([5c47617](https://github.com/MGrin/scani-oss/commit/5c4761777afb8672ac0dd3516fa213ff8f8f4ebf))
...
* **ui:** the mark comment points at a directory this repo does not have (SC-538) ([dcd7649](https://github.com/MGrin/scani-oss/commit/dcd7649a47f63cbdaf878d15c4608748469a4168))
...
* **v3:** name the unit on a holding's amount, and lead an account row to its holdings (SC-559, SC-560) ([b36108b](https://github.com/MGrin/scani-oss/commit/b36108b4bc35858002402e47c6faf8cbd6414710))
...
* **worker:** use the lock boot configures in both processors (SC-550) ([030df4b](https://github.com/MGrin/scani-oss/commit/030df4bef5f78dfb23c223ebcf13a4bc14291382))
...
* **worktree:** a path that does not exist is not a checkout ([cc9151e](https://github.com/MGrin/scani-oss/commit/cc9151e65f553360ebe8ca64533be3bd53881954))
