  ...
  return (
    <ToastPrimitives.Close
      ...
      className={cn(
        ...
        'absolute end-2 top-2 flex h-9 w-9 items-center justify-center rounded-md text-foreground/60 opacity-70 transition-opacity hover:text-foreground hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600',
        className
      )}
      toast-close=""
      {...props}
