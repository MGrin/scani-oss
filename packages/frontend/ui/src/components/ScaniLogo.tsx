...
// carries them by value, because it is a static file with no build step; it is
// not part of this repository, so changing the geometry here means changing
// that copy and regenerating the icon set separately.
