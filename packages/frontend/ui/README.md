...
Design system + shared client plumbing for the SPA (`apps/frontend/app`,
and any future React app). Anything that should look or behave the same
across apps lives here.
