-- Rollback script for 0015_mark_blockchain_integrations.sql
-- Reverts hasIntegration flag for blockchain institutions

-- Set has_integration back to false for all blockchain institutions
UPDATE institutions 
SET has_integration = false 
WHERE id IN (
...
SELECT 
  ...
  'Institutions with has_integration = false' as description
FROM institutions 
WHERE id IN (
  '45ab1358-a63c-4b5b-a305-082fa208ee0f',
  '71e709cf-f8db-48a3-877a-e19dadeeb6aa',
