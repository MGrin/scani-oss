...
// production, 122 on-chain events became 287 rows spread over nine accounts
// on three wallets, 165 of them copies of a transfer the account they sat on
// never made. The address has to come from the account.
