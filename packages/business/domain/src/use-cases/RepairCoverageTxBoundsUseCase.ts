 ...
 * writes to again — measured read-only on production 2026-08-18, 60 of 70
 * coverage rows were re-derived by that morning's imports and 5 were not,
 * because those holdings received no event. Those 5 keep whatever SC-308
