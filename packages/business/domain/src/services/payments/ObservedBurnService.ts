 ...
 * cannot silently reinterpret 6,300 EUR as 6,300 USD, and something has to
...
export class ObservedBurnService extends BaseService {
  ...
  async observed(
    ...
    // One prefetch for the batch. Per-flow lookups were 96-99% of an entire
    // request when this was measured on the account with real history
