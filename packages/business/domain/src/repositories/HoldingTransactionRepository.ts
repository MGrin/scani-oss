...
> {
   ...
   * worth running nightly. Production's Solana ledger spans 2021-10-02 to
   * 2026-06-01 with zero rows inside the last 30 days, so a 30-day sync of
   * it would have restored exactly nothing (SC-360).
   */
