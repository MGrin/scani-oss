...
describe('resolveCoingeckoId — an address outranks a symbol', () => {
   ...
   * a measurement, not a preference: that production row has had 0
   * CoinGecko prices in its life and 1854 DeFiLlama ones, and DeFiLlama
   ...
   * table (45 of the 95 production rows carrying a resolvable id). They
